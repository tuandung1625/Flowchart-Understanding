...
# python OCR/ocr_nodes_batch.py DATASET/Train/images --model runs/segment/runs/flowchart_seg_v2_exp1/weights/best.pt --output runs/ocr_batch

# # Chỉ xử lý 100 ảnh đầu tiên
# python OCR/ocr_nodes_batch.py DATASET/Train/images \
